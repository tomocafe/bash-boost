...
bb_expect "$(bb_abbrevpath "/foo/bar/baz" 20)" "/foo/bar/baz"
bb_expect "$(bb_abbrevpath "/foo/bar/baz" 10)" ".../baz"
bb_expect "$(bb_abbrevpath "/foo/bar/baz" 10 "x")" "x/bar/baz"
bb_expect "$(bb_abbrevpath "/foo/bar/baz/aaa/bbb" 10 "x")" "x/aaa/bbb"
bb_expect "$(bb_abbrevpath "/foo/averylongdir" 10)" "...longdir"
