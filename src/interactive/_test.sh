...
bb_bookmark a && bb_expect "$PWD" "$__bb_tmp_dir/aaa"
bb_bookmark b && bb_expect "$PWD" "$__bb_tmp_dir/aaa/bbb"
bb_bookmark 0 && bb_expect "$PWD" "$__bb_tmp_dir/aaa/000"
bb_bookmark 1 && bb_expect "$PWD" "$__bb_tmp_dir/aaa/000/111"
